...
Για την δημιουργία και υποβολή των εργασιών (tasks), που το καθένα θα εκτελεί την παραπάνω συνάρτηση busy\_work(), χρησιμοποιούμε μια ασύγχρονη συνάρτηση, ας την πούμε main(), η οποία πρώτα αρχικοποιεί το StarPUPy περιβάλλον καλώντας την συνάρτηση \texttt{starpu.init()}. Στην συνέχεια μέσα σε ένα βρόχο for δημιουργούνται και υποβάλλονται 8 εργασίες, οι οποίες εκτελούν την συνάρτηση busy\_work() για 8 δευτερόλεπτα η κάθε μία. Αυτό γίνεται με την επανειλημμένη χρήση της συνάρτησης \texttt{starpu.task\_submit()}. Τα αντικείμενα Future που επιστρέφονται από την υποβολή των εργασιών αποθηκεύονται σε μια λίστα futures. Παρακάτω φαίνεται το απόσπασμα κώδικα που περιγράφει την διαδικασία αυτή:
...
Τέλος για την εκτέλεση της main() συνάρτησης χρησιμοποιούμε την εντολή \texttt{asyncio\linebreak.run(main())}, η οποία εκκινεί το ασύγχρονο περιβάλλον και περιμένει την ολοκλήρωση της main() συνάρτησης. Παρακάτω φαίνεται το απόσπασμα κώδικα που περιγράφει την διαδικασία αυτή:
